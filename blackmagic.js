...
𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 𝐓𝐄𝐀𝐌 𝐀𝐑𝐗𝐔⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀
node blackmagic.js <web> <time> <per second request> <threads> <proxyfile>`));; process.exit();}
 const headers = {};
...
"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.4) Gecko/20070515 Firefox/2.0.0.4 (Kubuntu)",
 ...
 console.log(gradient.vice(`[!] 𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐒𝐄𝐍𝐓 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘.`));
 const KillScript = () => process.exit(1);
 console.log('METHOD BY NIGHT HUNTERS')
